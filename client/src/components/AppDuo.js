  ...
  return (
    <div className="row">
      <div style={{ width: `${resizerPos}px` }}>
        ...
        <Editor spectator ={spectator} editor={editor2} codeValue={codeValue1} socket={socket}/>
      ...
      >
        <Dropdown
          ...
          options={languages}
        />
        <Editor spectator ={spectator} editor={editor1} codeValue={codeValue2} socket ={socket}/>
